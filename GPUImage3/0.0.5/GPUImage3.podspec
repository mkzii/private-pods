#
#  Be sure to run `pod spec lint GPUImage3.podspec' to ensure this is a
...
An open source iOS framework for GPU-based image and video processing. This project is an open source project and has been used for development purposes.
  ...
  # Or just: spec.author    = "Anoop M"
  # spec.authors            = { "Anoop M" => "anoop@digiledge.in" }
  # spec.social_media_url   = "https://twitter.com/Anoop M"
  ...
  # spec.preserve_paths = "framework/Build/*"
  ...
  spec.frameworks = "Metal", "QuartzCore", "AVFoundation"
